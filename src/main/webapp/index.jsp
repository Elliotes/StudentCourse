...
--%>
	...
	<script>
		...
		function submitHandler() {
			...
			var action = null;
			if (role == 'student') {
				action = '${pageContext.request.contextPath}/LoginHandler/studentlogin';
				useridEle.name = "sid";
				passwordEle.name = "spassword";
			} else if (role == 'teacher') {
				action = "${pageContext.request.contextPath}/LoginHandler/teacherlogin";
				useridEle.name = "tid";
				passwordEle.name = "tpassword";
			} else {
				action = "${pageContext.request.contextPath}/LoginHandler/adminlogin";
